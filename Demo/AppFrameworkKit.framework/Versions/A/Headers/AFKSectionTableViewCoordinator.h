//
//  AFKSectionTableViewCoordinator.h
//  AppFrameworkKit
//
...
#import "AFKSectionTableViewModelProtocol.h"
#import "AFKTableViewCellManager.h"

/**
 SectionTableViewCoordinator (需要Section Footer/Header 情况下使用)
 */
@interface AFKSectionTableViewCoordinator : NSObject <UITableViewDelegate, UITableViewDataSource>
...
/**
 ...
 @return ViewModel实例
 */
- (id<AFKSectionTableViewModelProtocol>)createViewModel;
